-- Remove a lógica "sem vínculos = aceita todos os procedimentos" da RPC n8n_cs_consultar_vagas.
-- Antes: profissional sem nenhuma entrada em professional_procedures aparecia em qualquer busca.
-- Depois: quando um procedimento é especificado (v_proc IS NOT NULL), só aparecem profissionais
-- que têm explicitamente esse procedimento vinculado no painel.
-- Profissionais sem vínculo continuam aparecendo quando NÃO é especificado nenhum procedimento.
