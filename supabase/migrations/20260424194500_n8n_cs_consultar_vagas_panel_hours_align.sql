-- Lista as mesmas células de grade que o painel (cs_prof_panel_hours_for_prof_date).
-- Antes só cs_effective_hours (grade «oferecível» ao bot) podia omitir horário que o
-- painel mostra LIVRE — cliente via «15h indisponível» indevidamente.
