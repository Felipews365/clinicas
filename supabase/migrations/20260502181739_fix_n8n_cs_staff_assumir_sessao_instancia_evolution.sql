-- Fix: n8n_cs_staff_assumir_sessao usava coluna 'instance_name' que não existe
-- A coluna correta em 'clinics' é 'instancia_evolution'
...
DECLARE
  v_clinic_id uuid;
BEGIN
  -- Resolve clinic_id pelo instancia_evolution da Evolution API
  ...
  -- Desativa o bot para este cliente
  UPDATE cs_clientes
  SET bot_ativo = false
  ...
  -- Marca sessão whatsapp como staff a tratar
