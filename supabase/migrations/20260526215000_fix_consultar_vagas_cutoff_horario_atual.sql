-- Corrige o cutoff de horários da RPC n8n_cs_consultar_vagas.
-- Antes: cutoff = now() - 30min → às 15:30 ainda mostrava o slot das 15:00 (já passado).
-- Agora:  cutoff = now() exato  → às 15:30 o cutoff é 15:30 e, como slots são em hora cheia,
--         o primeiro disponível é 16:00. Comportamento correto para SaaS multi-tenant.
