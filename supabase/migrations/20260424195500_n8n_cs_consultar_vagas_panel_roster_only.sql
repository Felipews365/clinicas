-- Só lista vagas de cs_profissionais que têm linha em public.professionals (painel).
-- O dashboard ignora slots sem cs_profissional_id ligado (painel-dashboard slotLookup);
-- duplicados só em cs_profissionais geravam JSON enorme e o LLM dizia «indisponível» errado.
