...
export function ThemeToggle({ size = "md" }: { size?: "md" | "sm" }) {
  ...
  return (
    <button
      ...
      onClick={toggle}
      disabled={!mounted}
      className={`relative flex shrink-0 items-center justify-center border border-[var(--border)] bg-[var(--surface)] text-[var(--text)] transition-all duration-300 hover:bg-[var(--surface-soft)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary)] disabled:opacity-60 ${sizeClass}`}
    ...
    >
      <span
        ...
        aria-hidden
      >
        <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="currentColor" className="text-[var(--primary)]">
      ...
      <span
        ...
        aria-hidden
      >
        <svg width={moonSize} height={moonSize} viewBox="0 0 24 24" fill="currentColor" className="text-[var(--primary)]">
